...
public class GeckoThread extends Thread {
    ...
    private synchronized boolean init(final GeckoProfile profile, final String[] args,
        ...
        mProfile = profile;
        mArgs = args;
        mExtras = (extras != null) ? new Bundle(extras) : new Bundle(0);
        mFlags = flags;
    ...
    public static boolean initChildProcess(final String[] args, final Bundle extras,
        ...
        synchronized (INSTANCE) {
            final boolean result = INSTANCE.init(/* profile */ null, args,
                                                 extras, /* flags */ 0);
            INSTANCE.mExtras.putInt(EXTRA_IPC_FD, ipcFd);
            INSTANCE.mExtras.putInt(EXTRA_CRASH_FD, crashFd);
            INSTANCE.mExtras.putInt(EXTRA_CRASH_ANNOTATION_FD, crashAnnotationFd);
            return result;
        }
    }
