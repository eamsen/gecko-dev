...
const DEFAULT_ENVIRONMENT_PREFS = new Map([
  ...
  ["toolkit.formautofill.addresses.enabled", { what: RECORD_PREF_VALUE }],
  [
    "toolkit.formautofill.addresses.capture.enabled",
    { what: RECORD_PREF_VALUE },
  ],
  ["toolkit.formautofill.creditCards.enabled", { what: RECORD_PREF_VALUE }],
  ["toolkit.formautofill.creditCards.available", { what: RECORD_PREF_VALUE }],
  ["toolkit.formautofill.creditCards.used", { what: RECORD_PREF_VALUE }],
